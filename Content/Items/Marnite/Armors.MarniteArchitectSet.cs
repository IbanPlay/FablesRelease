...
namespace CalamityFables.Content.Items.Marnite
{
    ...
    [ReplacingCalamity("MarniteArchitectHeadgear")]
    public class MarniteArchitectHeadgear : ModItem
    {
        public static readonly SoundStyle LiftSpawnSound = new("CalamityFables/Sounds/MarniteLiftSummon");
        public static readonly SoundStyle LiftGoAwaySound = new("CalamityFables/Sounds/MarniteLiftUnsummon");
        public static readonly SoundStyle LiftHummSound = new("CalamityFables/Sounds/MarniteLiftHumm") { IsLooped = true };

        public static float LiftRaiseSpeed = 2f;
        public static float MaxLiftHeight = 170f;

        public override string Texture => AssetDirectory.Marnite + Name;

        public override void Load()
        {
            On_Player.QuickMount += ActivateLift;

            setBonusTitle = Mod.GetLocalization("Extras.ArmorSetBonus.MarniteArchitect.Title");
            setBonusTooltip1 = Mod.GetLocalization("Extras.ArmorSetBonus.MarniteArchitect.Tooltip1");
            setBonusTooltip2 = Mod.GetLocalization("Extras.ArmorSetBonus.MarniteArchitect.Tooltip2");
        }
        ...
        {
            CreateRecipe().
                AddRecipeGroup(FablesRecipes.AnyGoldCrownGroup).
            ...
            Recipe.Create(ItemType<MarniteArchitectToga>()).
                AddRecipeGroup(FablesRecipes.AnyGoldBarGroup, 2).
    ...
    [ReplacingCalamity("MarniteArchitectToga")]
    ...
    public class MarniteLift : ModMount
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            MountData.runSpeed = 2.2f; // The speed of the mount
            MountData.dashSpeed = 2.2f; // The speed the mount moves when in the state of dashing.
            ...
            if (Main.netMode != NetmodeID.Server)
            {
                MountData.frontTextureGlow = Request<Texture2D>(Texture + "Fire");
            }
        }
