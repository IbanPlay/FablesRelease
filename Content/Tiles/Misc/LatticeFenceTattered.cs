...
{
    public class LatticeFenceTattered : ModWall
    {
    ...
    public class LatticeFenceTatteredItem : ModItem
    {
        public override string Texture => AssetDirectory.MiscTiles + Name;
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.SetDefault("Tattered Lattice Fence");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.createWall = ModContent.WallType<LatticeFenceTattered>();
            Item.rare = 1;
            Item.value = 0;
        }
        ...
        public override void AddRecipes()
        {
            CreateRecipe(4).
                ...
                AddCustomShimmerResult(ItemType<LatticeFenceItem>()).
                Register();
        }
    }
