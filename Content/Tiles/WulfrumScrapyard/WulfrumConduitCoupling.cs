...
{
    public class WulfrumConduitCouplingVertical : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<WulfrumConduitCouplingItem>());
            AddMapEntry(new Color(124, 116, 81));
    ...
    public class WulfrumConduitCouplingHorizontal : ModTile
    {
        public override string Texture => AssetDirectory.WulfrumScrapyard + Name;
        ...
        public override void SetStaticDefaults()
        {
            ...
            ModContent.GetInstance<WulfrumConduitCouplingItem>().HorizontalConnectorType = Type;
            RegisterItemDrop(ModContent.ItemType<WulfrumConduitCouplingItem>());
            AddMapEntry(new Color(124, 116, 81));
    ...
    public class WulfrumConduitCouplingItem : ModItem
    {
        public override string Texture => AssetDirectory.WulfrumScrapyard + Name;
        ...
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Wulfrum Conduit Coupling");
            Item.ResearchUnlockCount = 10;
        }

        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<WulfrumConduitCouplingVertical>());
        }
