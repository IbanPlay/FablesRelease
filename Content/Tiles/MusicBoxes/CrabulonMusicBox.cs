...
{
    public class CrabulonMusicBoxItem : ModItem
    {
        public override string Texture => AssetDirectory.MusicBoxes + Name;

        public static int desperationMusicID;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Music Box (Mycelium Marionette)");
            ItemID.Sets.CanGetPrefixes[Type] = false;
            ItemID.Sets.ShimmerTransformToItem[Type] = ItemID.MusicBox;
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(CalamityFables.Instance, "Sounds/Music/Crabulon"), Type, ModContent.TileType<CrabulonMusicBox>());
            desperationMusicID = MusicLoader.GetMusicSlot(CalamityFables.Instance, "Sounds/Music/MushroomCaves");
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<CrabulonMusicBox>(), 0);
        }
    }

    public class CrabulonMusicBox : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(189, 190, 176), Language.GetText("ItemName.MusicBox"));
            RegisterItemDrop(ModContent.ItemType<CrabulonMusicBoxItem>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<CrabulonMusicBoxItem>();
        }
        ...
        public override void AnimateIndividualTile(int type, int i, int j, ref int frameXOffset, ref int frameYOffset)
        {
            ...
            if (t.TileFrameX >= 72)
                frameXOffset = 36 * ((int)(Main.timeForVisualEffects * 0.2f) % 14);
        }

        public override void NearbyEffects(int i, int j, bool closer)
        {
            if (Main.tile[i, j].TileFrameX >= 72)
                Main.SceneMetrics.ActiveMusicBox = CrabulonMusicBoxItem.desperationMusicID;
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Vector2 pos = new Vector2(i, j) * 16 - Main.screenPosition + offScreen + Vector2.UnitY * 2;
