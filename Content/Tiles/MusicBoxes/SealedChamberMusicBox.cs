...
{
    public class SealedChamberMusicBoxItem : ModItem
    {
        public override string Texture => AssetDirectory.MusicBoxes + Name;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Music Box (Sealed Chamber)");
            ItemID.Sets.CanGetPrefixes[Type] = false;
            ItemID.Sets.ShimmerTransformToItem[Type] = ItemID.MusicBox;
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(CalamityFables.Instance, "Sounds/Music/SealedChamber"), Type, ModContent.TileType<SealedChamberMusicBox>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<SealedChamberMusicBox>(), 0);
        }
    }

    public class SealedChamberMusicBox : ModTile
    {
        public override string Texture => AssetDirectory.MusicBoxes + Name;
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(198, 124, 76), Language.GetText("ItemName.MusicBox"));
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SealedChamberMusicBoxItem>();
        }
