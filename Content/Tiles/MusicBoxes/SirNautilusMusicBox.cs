...
{
    public class SirNautilusMusicBoxItem : ModItem
    {
        public override string Texture => AssetDirectory.MusicBoxes + Name;

        public static int nautilusMusicID;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Music Box (Beating A Dead Horseman)");
            ItemID.Sets.CanGetPrefixes[Type] = false;
            ItemID.Sets.ShimmerTransformToItem[Type] = ItemID.MusicBox;
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(CalamityFables.Instance, "Sounds/Music/Signathion"), Type, ModContent.TileType<SirNautilusMusicBox>());
            nautilusMusicID = MusicLoader.GetMusicSlot(CalamityFables.Instance, "Sounds/Music/Nautilus");
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<SirNautilusMusicBox>(), 0);
        }
    }

    public class SirNautilusMusicBox : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(37, 124, 184), Language.GetText("ItemName.MusicBox"));
            RegisterItemDrop(ModContent.ItemType<SirNautilusMusicBoxItem>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SirNautilusMusicBoxItem>();
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            if (Main.tile[i, j].TileFrameX >= 72)
                Main.SceneMetrics.ActiveMusicBox = SirNautilusMusicBoxItem.nautilusMusicID;
        }
