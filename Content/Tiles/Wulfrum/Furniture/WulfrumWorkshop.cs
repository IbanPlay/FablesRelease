...
{
    public class WulfrumWorkshopItem : ModItem
    {
        public override string Texture => AssetDirectory.WulfrumFurnitureItems + Name;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Wulfrum Workshop");
        ...
        {
            Item.DefaultToPlaceableTile(TileType<WulfrumWorkshop>());
            Item.maxStack = 9999;
        ...
        {
            CreateRecipe().
                AddIngredient(ItemType<WulfrumMetalScrap>(), 15).
                AddTile(TileID.WorkBenches).
                Register();
        }
    }

    public class WulfrumWorkshop : ModTile, ICustomPaintable
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            name.SetDefault("Wulfrum Workshop");
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            if (horizontalFrame == 0 || horizontalFrame == 9 || (horizontalFrame >= 3 && horizontalFrame <= 6))
                return;
