...
{
    public class WulfrumLampItem : ModItem
    {
        public override string Texture => AssetDirectory.WulfrumFurnitureItems + Name;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Wulfrum Lamp");
            Item.ResearchUnlockCount = 1;
        }

        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(TileType<WulfrumLamp>());
            Item.maxStack = 9999;
    ...
    public class WulfrumLamp : ModTile, ICustomPaintable
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(CommonColors.FurnitureLightYellow, Language.GetText("MapObject.FloorLamp"));
        ...
        public override void HitWire(int i, int j)
        {
            ...
            if (Main.dedServ)
                NetMessage.SendTileSquare(Main.myPlayer, i, j, 1, 3, TileChangeType.None);
        }

        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            if (Main.tile[i, j].TileFrameY == 0 && Main.tile[i, j].TileFrameX == 0)
            {
