...
{
    public class WulfrumBulkDoorItem : ModItem
    {
        public override string Texture => AssetDirectory.WulfrumFurnitureItems + Name;

        public static readonly SoundStyle OpenSound = new(SoundDirectory.Wulfrum + "WulfrumSmallDoorOpen") { Volume = 0.5f, Identifier = "WulfrumBulkDoorOpen", SoundLimitBehavior = SoundLimitBehavior.IgnoreNew, Pitch = -0.1f };
        public static readonly SoundStyle CloseSound = new(SoundDirectory.Wulfrum + "WulfrumSmallDoorClose") { Volume = 0.5f, Identifier = "WulfrumBulkDoorClose", SoundLimitBehavior = SoundLimitBehavior.IgnoreNew, Pitch = -0.1f };

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Wulfrum Bulk Door");
            Item.ResearchUnlockCount = 1;
        }

        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(TileType<WulfrumBulkDoorClosed>());
            Item.maxStack = 9999;
    ...
    public class WulfrumBulkDoorClosed : ModTile, ICustomPaintable, ICustomDoor
    {
        ...
        public SoundStyle InteractSound => WulfrumBulkDoorItem.OpenSound;
        ...
        public override void SetStaticDefaults()
        {
            ...
            name.SetDefault("Wulfrum Bulk Door");
            ...
            TileID.Sets.OpenDoorID[Type] = TileType<WulfrumBulkDoorOpen>();
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ItemType<WulfrumBulkDoorItem>();
        }
    }

    public class WulfrumBulkDoorOpen : ModTile, ICustomPaintable, ICustomDoor
    {
        public bool PaintColorHasCustomTexture(int paintColor) => CommonColors.WulfrumCustomPaintjob(paintColor);
        public string PaintedTexturePath(int paintColor) => CommonColors.WulfrumPaintName(paintColor, Name);
        ...
        public SoundStyle InteractSound => WulfrumBulkDoorItem.CloseSound;
        ...
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ItemType<WulfrumBulkDoorItem>());
            ...
            FablesSets.CustomPaintedSprites[Type] = true;
            FablesSets.CustomDoor[Type] = true;
            TileID.Sets.CloseDoorID[Type] = TileType<WulfrumBulkDoorClosed>();
        }
