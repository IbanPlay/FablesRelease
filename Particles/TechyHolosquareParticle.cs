namespace CalamityFables.Particles
{
    public class TechyHoloysquareParticle : Particle
    {
        ...
        public override string Texture => AssetDirectory.Particles + "TechyHolosquare";
        ...
        public override void CustomDraw(SpriteBatch spriteBatch, Vector2 basePosition)
        {
            ...
            FablesUtils.DrawChromaticAberration(Vector2.UnitX.RotatedBy(Rotation), 1.5f, delegate (Vector2 offset, Color colorMod) {
                spriteBatch.Draw(baseTex, Position + offset - basePosition, Frame, Color.MultiplyRGB(colorMod) * Opacity, Rotation, Frame.Size() / 2, Scale / 2f, SpriteEffects.None, 0);
            });
        }
    }
}
