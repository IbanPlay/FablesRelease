namespace CalamityFables.Particles
{
    ...
    {
        public override string Texture => AssetDirectory.Particles + "Sparkle";
        ...
        public override void CustomDraw(SpriteBatch spriteBatch, Vector2 basePosition)
        {
            ...
            spriteBatch.Draw(bloomTexture, Position - basePosition, null, Bloom * opacity * 0.5f, 0, bloomTexture.Size() / 2f, Scale * BloomScale * properBloomSize, SpriteEffects.None, 0);
            spriteBatch.Draw(starTexture, Position - basePosition, null, Color * opacity * 0.5f, Rotation + MathHelper.PiOver4, starTexture.Size() / 2f, Scale * 0.75f, SpriteEffects.None, 0);
            spriteBatch.Draw(starTexture, Position - basePosition, null, Color * opacity, Rotation, starTexture.Size() / 2f, Scale, SpriteEffects.None, 0);
        }
    }
}
