...
namespace CalamityFables.Particles
{
    ...
    {
        public override string Texture => AssetDirectory.Particles + "Light";
        ...
        public CurveSegment goBack = new CurveSegment(SineInOutEasing, 0f, 1f, 0.25f);
        public CurveSegment goForward = new CurveSegment(SineInEasing, 0.35f, 1.25f, -1.25f);
        public float offsetPosition() => PiecewiseAnimation(LifetimeCompletion, new CurveSegment[] { goBack, goForward });

        public CurveSegment noSquish = new CurveSegment(LinearEasing, 0f, 1f, 0f);
        public CurveSegment squishSpeed = new CurveSegment(SineInEasing, 0.35f, 1f, 0.8f);
