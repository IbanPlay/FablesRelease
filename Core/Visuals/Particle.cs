namespace CalamityFables.Core
{
    public class Particle : Entity
    {
        ...
        /// </summary>
        public virtual bool SetLifetime => true;
        /// <summary>
        ...
        /// <summary>
        /// Should the particle draw in front of eerything
        /// </summary>
        ...
        /// <summary>
        /// The texture path of the particle
        /// </summary>
        public virtual string Texture => "";

        public Texture2D ParticleTexture => ParticleHandler.GetTexture(Type);
        ...
        /// </summary>
        public virtual bool UsesNonPremultipliedAlpha => false;

        /// <summary>
        /// Removes the particle from the handler
        /// </summary>
        public void Kill() => ParticleHandler.RemoveParticle(this);
